...
//			var query = tb_urlList.query();
	...
	$("div.cus_search input").keypress(function(ev){
	 ...
	 //UrlList Call
	calls.init({name:'urlList',url:'http://logs.naukri.com/nLogger/boomGetUrls.php',responseVarName:'urlList',callback:callback.fillUrlTable}).trigger({el:$('#urlListGrid')},{offset : tb_urlList.offset,count:tb_urlList.count,query:tb_urlList.getQuery()});	
