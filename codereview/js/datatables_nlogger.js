...
$(document).ready(function() {
    ...
    var oTable = $('#example2').dataTable( {
	   //"sDom": "<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span12'p i>>",
	   "sDom": "<'row-fluid'<'span12'l <'toolbar'>>r>t<'row-fluid'<'span12'p i>>", // MIS
       "aaSorting": [],
				"oLanguage": {
			"sLengthMenu": "_MENU_ ",
			"sInfo": "Showing <b>_START_ to _END_</b> of _TOTAL_ entries"
	...
	$("div.toolbar").html('<div class="table-tools-actions"><button class="btn btn-primary pull-right" style="margin-left:12px" id="test2">Filter</button></div>'); // MIS
